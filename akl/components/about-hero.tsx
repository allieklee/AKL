export const AboutHero = () => {
  return (
    <div className="bg-egg px-4 md:px-8 pb-8">
      <div className="px-2 bg-offwhite rounded pb-4">
        <div className="grid justify-items-center">
          ...
          <div className="text-4xl sm-text-3xl font-serif text-center font-bold text-gray-800 pt-4 pb-2">
            Hi, I&apos;m Allie!
          </div>
        ...
        <div className="flex flex-col px-2 md:px-20">
          ...
          <div className="flex justify-center text-lg font-serif text-gray-600">
            In the past few years, I went through a lot. I fell apart and put
            myself back together countless times. While these years have been
            challenging, I have learned a lot.
          </div>
          <div className="flex justify-center text-lg font-serif text-gray-600 pt-6">
            ...
            sophomore year of college, when I made a terrifying choice to derail my
            life plans and pursue the major. I hope to inspire other women in
            tech by sharing my journey.
          </div>
          <div className="flex justify-start text-4xl font-serif text-gray-700 font-bold py-4">
            who am I?
          </div>
          ...
          <div className="grid justify-items-center">
            <div className="grid grid-cols-3 gap-4 text-sm font-serif text-gray-600 pt-2 sm:w-full md:w-3/4">
              <img src="./family.jpg" className="outline outline-gray-600" />
              <img src="./concert.jpg" className="outline outline-dustypink" />
              <img src="./friends.jpg" className="outline outline-gray-600" />
              <img src="./seth.jpg" className="outline outline-dustypink" />
              <img src="./valpo.jpg" className="outline outline-gray-600" />
              <img src="./mosie.jpg" className="outline outline-dustypink" />
            </div>
          </div>
        </div>
      </div>
